...
"pkglib.variant.select": "Use this variant for Install all on this PS5",
"pkglib.variant.selected": "Selected for Install all on this PS5",
"pkglib.variant.help": "Every update/DLC variant is preserved below. Choose one same-version alternative for this PS5; Install all uses the selected row and leaves its siblings staged.",
