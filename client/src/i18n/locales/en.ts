...
nav_section_files: "Files & storage",
...
nav_section_games_mods: "Games & content",
nav_section_payload_tools: "Payload tools",
...
activity_preparing_hint:
  "Preparing… no data transferred yet. Compressed archives (.zip/.rar/.7z) are decompressed on your computer as they upload — large entries can take a moment before the live speed appears.",
activity_live_speed: "{speed}/s live",
...
payload_not_connected_message: "Add your console address and send the helper once. We’ll verify capabilities before enabling console actions.",
...
// Library screen (now Games tab)
games_title: "Games",
games_tab_ready: "Ready to play",
games_tab_files: "Game files",
games_ready_description: "Games registered on this PS5. Launch, stop, inspect, or uninstall them here.",
games_files_description: "Game folders and disk images found in console storage. Mount, register, move, or inspect source files here.",
library: "Library",
...
hw_m2_not_installed: "No M.2 drive installed or sensor unavailable",
...
playlist_add_repo_step: "Add repo step",
playlist_add_repo_step_hint: "Add a step fetched from a repo at run time — no local file needed.",
playlist_repo_picker_title: "Add a repo step",
playlist_repo_picker_hint: "Pick a payload. The playlist fetches its latest release and caches it when you run — so you don't keep the file on your PC. Add your own repos on the Catalog tab.",
playlist_repo_picker_search: "Search payloads…",
playlist_repo_picker_loading: "Loading catalogue…",
playlist_step_repo_badge: "Repo",
playlist_step_repo_hint: "Fetched from the {id} repo at run time — no local file needed.",
...
"pkglib.meta.file": "File:",
"pkglib.meta.source": "Source:",
"pkglib.meta.uploaded": "Uploaded:",
"pkglib.meta.onPs5": "On PS5:",
"pkglib.group.count": "Packages: {n}",
"pkglib.section.base": "Base game",
"pkglib.section.updates": "Updates",
"pkglib.section.dlc": "DLC",
"pkglib.variant.select": "Include in Install all (this PS5)",
"pkglib.variant.selected": "Included in Install all (this PS5)",
"pkglib.variant.help": "When several packages are the same game update or DLC, pick exactly one for the bulk Install all button. Uncheck to leave it out. Single Install on the row always installs this package only.",
...
ffpkg_extract_done: "Files written: {files} ({bytes})",
...
hw_drives_title: "Drives",
hw_drive_access_denied: "Access denied",
hw_drive_no_temp: "No temp sensor",
hw_drive_free: "Free",
klog_clear: "Clear",
klog_copy: "Copy",
...
library_mount_modal_read_only_hint: "— safest, and right for shared dumps or save-data PFS images. Leave it OFF to edit the image: replace files, add DLC, or apply a backport patch. Requires payload 2.2.26+.",
...
payloads_add_repo_title: "Track a custom payload repo",
payloads_add_repo_hint: "Paste owner/name (e.g. EchoStretch/kstuff-lite) or a full repo URL. Releases are fetched the same way as the curated list; the same ELF/zip checks apply on download. Only add repos you trust — ps5upload doesn't vet what a custom repo ships.",
payloads_add_repo_placeholder: "owner/name or https://github.com/owner/name",
payloads_add_repo_host: "Host",
payloads_add_repo_host_hint: "Used only when you enter a bare owner/name. GitHub or a Gitea/Forgejo host.",
payloads_add_repo_submit: "Add",
payloads_custom_parse_error: "Enter owner/name (e.g. EchoStretch/kstuff-lite) or a full repo URL.",
payloads_custom_added: "Added {name}",
payloads_custom_added_body: "Check its releases and send it like any other payload.",
payloads_custom_removed: "Removed {name}",
payloads_custom_badge: "Custom",
payloads_custom_remove: "Remove this custom repo",
payloads_custom_remove_short: "Remove",
...
payloads_description_shadowmount: "Inspect ShadowMount+ status, mounted game images, configuration, and diagnostics on the selected PS5.",
payloads_description_nanodns: "Configure the nanoDNS payload, verify its running version, and apply safe config migrations.",
navigation_history: "View history",
...
playlist_step_count: "Steps: {count}",
...
saves_ps4_warning_title: "PS4-format saves:",
saves_ps4_warning_body: "backup and restore of PS4 legacy saves (like PS4 games running via backward compatibility) may not work reliably — the PS4 emulator caches save data internally and a raw file copy back to the console doesn't always trigger a remount. If a restored PS4 save doesn't appear in-game, try closing and reopening the game, or restarting the console. This is a known limitation tracked in issue #198.",
...
saves_backup_usb: "Save to USB",
saves_backup_usb_tooltip: "Back this save up to the USB save path configured in Settings, without leaving the PS5.",
saves_backup_usb_all: "Back up all to USB",
saves_backup_usb_no_volume: "No writable USB/external drive found at {path}. Plug it into the PS5 and try again.",
saves_backup_usb_low_space: "Not enough free space at {path} for this backup.",
saves_backup_usb_summary: "Backed up {ok}/{total} to USB",
saves_backup_usb_summary_failed: "Backed up {ok}/{total} to USB; {failed} failed",
saves_restore_usb: "Restore from USB",
saves_restore_usb_tooltip: "Restore this save from its latest USB backup at the path configured in Settings, without leaving the PS5. Overwrites the live save.",
saves_restore_usb_all: "Restore all from USB",
saves_restore_usb_confirm_title: "Restore {title} from USB backup {timestamp}?",
saves_restore_usb_confirm_body: "This WIPES the current PS5 save for {title} and replaces it with the backup from {timestamp}. There is no automatic rollback if the upload is interrupted. Back up the existing save first if it matters.",
saves_restore_usb_confirm_label: "Restore from USB",
saves_restore_usb_all_confirm_title: "Restore all saves from USB?",
saves_restore_usb_all_confirm_body: "This will WIPE the current PS5 save for each game and replace it with its latest USB backup. Games with no backup on the USB drive are skipped. There is no automatic rollback if an upload is interrupted.",
saves_restore_usb_all_confirm_label: "Restore all",
saves_restore_usb_no_backup: "No USB backup found for {title} at {path}.",
saves_restore_usb_summary: "Restored {ok}/{total} from USB",
saves_restore_usb_summary_partial: "Restored {ok}/{total} from USB; {failed} failed, {skipped} skipped",
schedules_add: "Add daily",
schedules_caveat: "These are in-app reminders, not background automation. They fire only while ps5upload is open; closing the app stops them. For unattended overnight actions, use a trusted local system scheduler or keep the app open.",
...
settings_section_schedules: "In-app reminders",
settings_group_general: "General",
settings_group_uploads: "Uploads",
settings_group_a11y: "Accessibility",
settings_section_a11y: "Accessibility",
a11y_motion: "Motion",
a11y_motion_label: "Animation motion mode",
a11y_motion_auto: "Auto",
a11y_motion_full: "Full",
a11y_motion_reduced: "Reduced",
a11y_motion_none: "None",
a11y_motion_hint:
  "Auto follows your OS setting. Reduced plays transitions at 0.4× speed; None disables them entirely.",
a11y_density: "Density",
a11y_density_label: "Layout density mode",
a11y_density_comfortable: "Comfortable",
a11y_density_compact: "Compact",
a11y_density_spacious: "Spacious",
a11y_density_hint:
...
a11y_color_blind: "Color blind palette",
a11y_color_blind_label: "Color blind palette adjustment",
a11y_color_blind_hint:
  "Adjusts status colors (success/warn/error) to be distinguishable for the selected color vision type.",
a11y_cb_default: "Default",
a11y_cb_deuteranopia: "Deuteranopia (red-green)",
...
settings_card_save_path: "Save backups",
save_path_label: "USB save path",
...
smp_autotune_save: "Save edits ({count})",
...
cmdpalette_esc: "Esc",
table_select_all: "Select all rows",
table_select_row: "Select row {n}",
table_loading_more: "Loading more… ({shown}/{total})",
...
health_rescan: "Scan again",
health_scanning: "Checking your console\u2026",
health_all_good: "Everything looks right",
health_has_warnings: "A few things worth a look",
health_has_failures: "Something needs attention",
health_cat_connectivity: "Connection",
health_cat_runtime: "Helper",
health_cat_storage: "Storage",
health_cat_system: "System",
health_cat_remoteplay: "Remote Play",
health_cat_hygiene: "Housekeeping",
health_fix: "Fix",
health_fixing: "Fixing\u2026",
health_fix_done: "Done.",
health_fix_failed: "The repair failed.",
health_junk_title: "Delete leftover files?",
health_junk_explain:
...
cheats_your_games: "Your games",
cheats_your_games_hint: "Click a game to find cheats for it, or search below.",
cheats_loading_games: "Loading your games\u2026",
cheats_search_action: "Search",
cheats_install: "Install",
cheats_installing: "Installing\u2026",
cheats_installed: "Installed",
game_activity_reset: "Reset play time",
game_activity_reset_title: "Reset play time?",
...
game_activity_reset_confirm: "Reset",
game_activity_resetting: "Resetting\u2026",
...
hardware_fan_active: "Permanent fan speed active at",
...
search_match_progress: "matches",
search_so_far: "so far",
search_in: "in",
search_match_result: "matches",
...
upload_pkg_fw12_note:
  "FW 12+ package support depends on the jailbreak and Sony's AppInst/PlayGo path. ps5upload keeps the staged package and reports a verified result; if the console rejects it, use its Debug Settings Package Installer.",
...
upload_mount_readonly_desc: "Recommended. Prevents the PS5 from writing save data into the image (which would silently corrupt the file on disk and break re-mount). Turn it off when you intend to edit the image — replacing files, adding DLC, or applying a backport patch — and remember those edits are permanent.",
...
sendpayload_port_jar_desc: "BD-JB / BDJ runtime",
  ...
  sendpayload_checking_file: "Checking file…",
  sendpayload_success: "success",
  sendpayload_failed: "failed",
...
shortcuts_activate: "Open / activate",
  ...
  "pkglib.stream.fallback.title": "Stream is blocked on this PS5",
  "pkglib.stream.fallback.confirm": "Upload & install",
  "pkglib.stream.fallback.cancel": "Not now",
  ...
  backup_subtitle: "Keep a copy of files from the console, and put them back when needed",
  backup_new_snapshot: "New snapshot",
  backup_tag_label: "Name for this snapshot",
  backup_tag_placeholder: "homebrew-2026-08-20",
  backup_path_label: "What to copy",
  ...
  ps5notif_title: "On-screen messages",
  ps5notif_description: "Messages ps5upload has shown on your TV",
  ps5notif_empty: "Nothing shown yet",
  ps5notif_empty_hint: "When ps5upload puts a message on your TV — a Remote Play PIN, an install finishing — it is listed here so you can read it again. This is not the PS5's own notification panel; the console does not let us read that.",
  ...
  // Cheats extras
  cheats_status_enabled: "Enabled",
  cheats_status_disabled: "Disabled",
  cheats_game_label: "Game:",
  cheats_pid_label: "(PID:",
  cheats_unknown: "unknown",
  cheats_patches_applied: "patches applied",
  ...
  // Tmdb extras
  tmdb_title: "Game Metadata",
  tmdb_subtitle: "Look up a game's name and details, cached on the console",
  tmdb_not_found: "No metadata found for that title on this console.",
  tmdb_not_cached: "Not cached yet — fetching from the console.",
  ...
  tmdb_region_title: "Region prefix (e.g. UP9000 for US, EP1018 for EU). Leave empty to search all regions.",
  tmdb_region_hint: "Region prefix (e.g. UP9000=US, EP1018=EU, JP9000=JP) speeds up lookup by trying only that region instead of all 24.",
  tmdb_field_np_title_id: "NP Title ID:",
  tmdb_field_content_id: "Content ID:",
  tmdb_field_category: "Category:",
  tmdb_field_publisher: "Publisher:",
  tmdb_field_release_date: "Release Date:",
  ...
  // ── v5 Tab navigation ──────────────────────────────────────────
  v5_tab_primary_nav: "Primary",
  v5_tab_home: "Home",
  v5_tab_home_desc: "Dashboard and quick actions",
  v5_tab_games: "Games",
  v5_tab_games_desc: "Library, installed apps, and game hubs",
  v5_tab_files: "Files",
  v5_tab_files_desc: "Browse and transfer files",
  v5_tab_console: "Console",
  v5_tab_console_desc: "System info, hardware, and tools",
  v5_tab_tasks: "Tasks",
  ...
  // ── v5 Home screen ────────────────────────────────────────────
  v5_home_title: "Home",
  v5_home_subtitle: "Manage your console, move content, and monitor active work.",
  v5_home_command_center: "Command center",
  v5_home_connected: "Connected",
  v5_home_disconnected: "Not connected",
  v5_home_setup_required: "Setup required",
  v5_home_connect_title: "Connect a PS5 to get started",
  v5_home_connect: "Connect PS5",
  v5_home_console_ready: "Your PS5 is ready",
  v5_home_console_ready_desc: "Helper connected. Console operations are available.",
  v5_home_manage_connection: "Manage connection",
  v5_home_connection: "Connection",
  v5_home_console_status: "Console status",
  v5_home_console_status_desc: "Connection and live system health.",
  v5_home_host: "Host",
  v5_home_engine: "Engine",
  v5_home_helper: "Helper",
  v5_home_kernel: "Kernel",
  v5_home_krw: "Kernel R/W",
  v5_home_available: "available",
  v5_home_missing: "missing",
  v5_home_sensors: "Live sensors",
  v5_home_cpu: "CPU",
  v5_home_soc: "SoC",
  v5_home_m2: "M.2 SSD",
  v5_home_lifetime: "Lifetime",
  v5_home_boots: "boots",
  v5_home_loading_sensors: "Reading sensors…",
  v5_home_sensor_live: "Updates automatically",
  v5_home_sensor_waiting: "Available after connection",
  v5_home_quick_actions: "Quick actions",
  v5_home_quick_actions_desc: "Start the jobs you use most.",
  v5_home_running: "Running ({n})",
  v5_home_more: "more",
  v5_home_recent_activity: "Recent activity",
  v5_home_recent_activity_desc: "Latest operations across every console.",
  v5_home_no_activity: "No recent activity.",
  v5_home_no_activity_desc: "Uploads, installs, and file jobs will appear here.",
  v5_home_notifications: "Notifications",
  v5_home_notifications_desc: "Important results and warnings.",
  v5_home_no_notifications: "No notifications.",
  v5_home_no_notifications_desc: "New alerts will appear here.",
  v5_home_view_all: "View all",
  // ── v5 Home quick actions ─────────────────────────────────────
  v5_qa_upload: "Upload",
  v5_qa_install: "Install PKG",
  v5_qa_saves: "Backup saves",
  v5_qa_ftp: "Start FTP",
  v5_qa_files: "Files",
  v5_qa_games: "Games",

  // ── Upload screen extras ──────────────────────────────────────
  upload_override: "Override",
  upload_start_upload: "Start upload",
  upload_override_desc: "Replace everything — re-send the entire source.",
  upload_start_desc: "Send all files to the PS5.",
  upload_cancel_existing_desc: "Don't upload. Pick a different destination or source.",
  ...
  upload_preset_homebrew_hint: "Homebrew apps & games (recommended)",
  upload_preset_etahen_hint: "etaHEN game folder (etaHEN app loader scans here)",
  upload_preset_exfat_hint: "Disk images",
  upload_preset_ps5upload_hint: "Tool-specific generic folder",
  upload_mode_all_hint: "Default. Nothing is filtered.",
  upload_mode_rules_hint: "Skip junk files and anything you add below.",
  upload_add_pattern_placeholder: "Add pattern (e.g. *.log)",

  // ── Hardware / Fan presets ────────────────────────────────────
  hw_fan_preset_quiet: "Quiet",
  hw_fan_preset_quiet_hint: "Fan engages earlier — cooler, louder",
  hw_fan_preset_balanced: "Balanced",
  hw_fan_preset_balanced_hint: "Close to Sony's default",
  hw_fan_preset_performance: "Performance",
  hw_fan_preset_performance_hint: "Fan ramps only under load — quieter idle",

  // ── Settings retention labels ─────────────────────────────────
  settings_retention_7: "7 days",
  settings_retention_30: "30 days",
  settings_retention_90: "90 days",
  settings_retention_never: "Never (keep all)",
  settings_unit_mbs: "MB/s",

  // ── Cheats extras ─────────────────────────────────────────────
  cheats_enable: "Enable",
  cheats_disable: "Disable",

  // ── FwSpoof extras ────────────────────────────────────────────
  fw_spoof_unknown: "Unknown",
  fw_spoof_yes: "Yes",
  fw_spoof_no: "No",

  // ── Payloads SendPanel ────────────────────────────────────────
  payloads_checking_file: "Checking file…",
  payloads_status_success: "success",
  payloads_status_failed: "failed",
  payloads_unit_ms: "ms",
  ...
  // ── Components ────────────────────────────────────────────────
  shapes_loader_default: "Loading",

  // ── v4.5.0: Missing keys from i18n coverage ─────────────────────
  bringup_failed_title: "Bring-up failed",
  cheats_description: "Apply memory patches to running games. Supports JSON, SHN, and patch files.",
  cheats_download_title: "Download Community Cheats",
  cheats_engine: "Cheat Engine",
  cheats_mods: "Mods",
  cheats_no_mods: "No mods found",
  cheats_no_mods_hint: "This title has no cheat file or it is empty",
  cheats_no_titles: "No cheat files",
  cheats_no_titles_hint: "Upload cheat files to /data/ps5upload/cheats/ on the PS5",
  cheats_search_hint: "Enter a game name or title ID (e.g. CUSA00001) and press Search",
  cheats_search_placeholder: "Search by game name or CUSA ID...",
  cheats_select_title: "Select a title",
  cheats_select_title_hint: "Choose a game from the list to view available cheats",
  cheats_title: "Cheats",
  cheats_titles: "Titles",
  connection_discover_error_title: "Error",
  fanCurve_persisted: "A fan curve is saved on this PS5. The first point's temperature is the active fan threshold and auto-restores on every payload load — no desktop app needed.",
  fs_bulk_error_title: "Error",
  fs_download_error_title: "Download failed",
  fs_error_title: "Error",
  fw_spoof_kern_version: "Kernel Build",
  game_activity_active: "Active",
  game_activity_db_unavail: "Database unavailable on this firmware",
  game_activity_empty: "No tracked activity yet",
  game_activity_empty_desc: "Play time is counted only while the ps5upload helper is running on your console. Load the helper, then play — sessions from before it was loaded cannot be recovered.",
  game_activity_last: "Last",
  ...
  game_activity_subtitle: "Play time counted while the helper runs, plus what the console already knows",
  game_activity_title: "Game Activity Tracker",
  game_activity_total: "counted while helper ran",
  game_activity_tracked: "Tracked Playtime",
  queue_error: "Error",
  fakelib_title: "Fakelib (backport libraries)",
  fakelib_subtitle: "Give a game the newer system libraries it needs to run on your firmware",
  fakelib_explain: "A game built for newer firmware needs that firmware's system libraries. Put them here and BackPork mounts them into the game when it launches, leaving the originals untouched. Run the BackPork payload from the Payloads screen for this to take effect.",
  fakelib_explain_pair: "This is the second half of a backport — the game's own files also need their required firmware lowered, on the SDK Version Changer screen. Libraries usually need a BPS patch first to remove functions your firmware does not have.",
  fakelib_no_titles: "No folder-installed games",
  fakelib_no_titles_desc: "Only games installed as a folder can take replacement libraries. Titles mounted from a disk image are read-only.",
  fakelib_pick_title: "Game",
  fakelib_select: "Select a game",
  fakelib_empty: "No libraries added yet.",
  fakelib_add: "Add library",
  fakelib_choose_patch: "Choose .bps patch",
  fakelib_change_patch: "Change patch",
  fakelib_clear_patch: "No patch",
  fakelib_patch_active: "Patch will be applied:",
  fakelib_pick_lib: "Choose a library (.sprx / .prx)",
  fakelib_pick_patch: "Choose a .bps patch",
  fakelib_patching: "Applying patch…",
  fakelib_uploading: "Uploading…",
  fakelib_added: "Library added",
  fakelib_patch_ready: "Patch loaded",
  sdk_changer_subtitle: "Lower the firmware a game demands, so it will launch on an older console",
  sdk_changer_title: "SDK Version Changer",
  sdk_confirm: "Confirm",
  sdk_fw: "FW",
  sdk_no_titles: "No titles found",
  sdk_no_titles_desc: "No installed apps detected in /user/appmeta",
  sdk_patch: "Patch",
  sdk_patch_ok: "Patched {titleId} → {targetSdk}",
  sdk_pkg_unpatchable: "Package-installed or unavailable source — cannot safely patch in place",
  sdk_restore: "Restore",
  sdk_restore_no_backup: "No backup files found for {titleId}.",
  sdk_restore_ok: "Restored {count} file(s) for {titleId} from backup.",
  sdk_restore_tooltip: "Restore original files from .bak backups",
  sdk_source: "Source",
  sdk_explain_what: "Every game records the minimum firmware it needs. If that is higher than your console's firmware, the system refuses to start it. This screen lowers that recorded value.",
  sdk_explain_half: "This is only half of a backport.",
  sdk_explain_half_text: "Lowering the version gets the system to agree to launch the game — it will then usually crash on functions your firmware does not have. To finish the job you also need the newer system libraries, which BackPork mounts into the game at launch (see the Payloads screen).",
  sdk_explain_decrypted: "Only decrypted games can be patched. Retail titles installed from disc or Store are encrypted, and those are reported as signed SELFs and skipped rather than damaged.",
  sdk_target_fw: "Target firmware",
  sdk_bad_fw: "Not a firmware version",
  sdk_sdk: "SDK",
  sdk_warning: "Warning:",
  sdk_warning_text: "Patching rewrites game binaries and param.json in place. Originals are copied to .bak first, and Restore puts them back. Use at your own risk.",
  transfer_log_title: "Transfer Log",
  upload_detect_error_title: "Error",
  upload_preflight_error_title: "Preflight check failed",
  // ─ v5 unified task list ─
  task_active: "Active",
  task_recent: "Recently finished",
  task_clear_finished: "Clear finished",
  task_cancel: "Cancel",
  task_resume: "Resume",
  task_pause: "Pause",
  task_retry: "Retry",
  task_dismiss: "Dismiss",
  ...
  game_hub_saves: "Saves",
  game_hub_media: "Media",
  game_hub_addons: "Add-ons",
  game_hub_updates: "Updates",
  game_hub_storage: "Storage",
  game_hub_playtime: "Play Time",
  game_hub_launch: "Launch",
  game_hub_launch_cheats: "Launch with cheats",
  game_hub_back: "Back to library",
  game_hub_not_found: "Game not found",
  game_hub_not_found_desc: "This title ID does not match any installed or library game.",
  game_hub_title_id: "Title ID",
  game_hub_name: "Name",
  game_hub_size: "Size",
  game_hub_path: "Path",
  game_hub_total_play_time: "Total play time",
  game_hub_last_played: "Last played",
  game_hub_game_data: "Game data",
  game_hub_size_unavailable: "Size information unavailable.",
  ...
  telemetry_disk: "Disk usage",
  telemetry_no_data: "No telemetry data yet. Connect to a PS5 to start streaming.",
  telemetry_sampling: "Live · {interval}s interval",
  telemetry_not_connected: "Not connected",
  telemetry_not_connected_desc: "Connect to your PS5 to see live telemetry.",
  telemetry_waiting: "Waiting for data",
  telemetry_waiting_desc: "Sensor readings will appear here within a few seconds.",
  telemetry_cpu_temp: "CPU Temp",
  telemetry_soc_temp: "SoC Temp",
  telemetry_fan_duty: "Fan Duty",
  telemetry_power: "Power",
  telemetry_lifetime: "Lifetime",
  telemetry_operating_hours: "Operating time",
  telemetry_boot_count: "Boot count",
  telemetry_load_avg: "Load avg (1m)",
  telemetry_overview: "Overview",
  telemetry_cpu_usage: "CPU usage",
  telemetry_cpu_freq: "CPU freq",
  telemetry_soc_power: "SoC power",
  telemetry_m2_temp: "M.2 SSD",
  telemetry_samples: "samples",
  telemetry_window: "Last ~",
  telemetry_minutes: "min",
  telemetry_ghz: "GHz",
  telemetry_watts: "W",
  activity_view_telemetry: "Telemetry",
  remotePlay_registry_unreadable: "Couldn't read this console's settings, so Remote Play status is unknown. Reload the helper and try again.",
  remotePlay_check_user: "Someone is signed in",
  remotePlay_check_user_hint: "Sign in on the console — Remote Play pairs with whoever is on screen.",
  remotePlay_slot: "user {slot}",
  remotePlay_check_account: "Account is activated",
  remotePlay_check_account_hint: "This account has never been activated, so it cannot pair. Activating changes account data and can affect save games, so ps5upload does not do it for you yet.",
  remotePlay_check_service: "Remote Play is on",
  remotePlay_turn_on: "Turn on",
  remotePlay_check_peruser: "Remote Play is allowed for this user",
  remotePlay_fw10: "firmware 10.00 and later",
  remotePlay_allow_user: "Allow",
  remotePlay_readiness: "Before you pair",
  remotePlay_fw: "firmware {fw}",
  tmdb_explain: "Fetches a game's proper name and cover details from the PlayStation Store and caches them on the console. Useful when a game shows up as a bare ID or a blank tile.",
  tmdb_pick_game: "Pick a game",
  tmdb_no_installed: "No games found on this console. You can still enter an ID by hand below.",
  tmdb_show_manual: "Enter an ID by hand instead",
  tmdb_hide_manual: "Hide manual entry",
  backup_explain: "Copies files from the console to this computer so you can put them back later. Pick something common below, or type your own path.",
...
upload_split_pick_entry_title: "Pick \"{name}\" instead",
upload_split_pick_entry_body: "This is one volume of a split set, not the whole archive. Choose the file above and the remaining volumes are read automatically — you don't need to upload them separately.",
upload_split_unsupported_title: "This is a split archive ({count} volumes) that ps5upload can't open",
...
fs_add_files: "Add files",
fs_add_files_dialog_title: "Pick files to copy onto the PS5",
fs_replace: "Replace file",
fs_replace_tooltip: "Overwrite this file with one from your computer — how you patch a file inside a mounted game image",
fs_replace_dialog_title: "Pick the file to replace \"{name}\" with",
fs_replace_confirm_title: "Replace this file?",
fs_replace_confirm_body: "\"{name}\" will be overwritten and the old contents are gone for good. If this is inside a mounted game image, a bad file can stop the game booting.",
fs_replace_confirm_ok: "Replace",
...
installed_bring_to_front: "Bring to front",
installed_bring_to_front_tooltip: "Bring this running game to the screen. Use it once the game has finished loading — the PS5 ignores it while a title is still starting.",
installed_bring_to_front_sent: "Asked the PS5 to show {name}. If nothing happens it's still loading — try again in a moment.",
installed_bring_to_front_failed: "Couldn't bring it to the screen",

installed_bring_to_front_confirm_title: "{name} is running but not on screen",
...
installed_bring_to_front_raised: "{name} is on screen now.",
installed_bring_to_front_already: "{name} is already the app on screen.",
installed_bring_to_front_not_running: "{name} isn't running, so there's nothing to bring forward.",
installed_bring_to_front_unverifiable: "Asked the PS5 to show {name}. This console can't report which app is on screen, so we can't confirm it worked.",
installed_bring_to_front_not_raised_title: "The PS5 didn't switch to it",
installed_bring_to_front_not_raised: "{name} is still running, but the console kept the screen where it was. Press the PS button on your controller and pick it from there.",
