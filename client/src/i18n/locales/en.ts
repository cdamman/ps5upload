...
shortcuts_activate: "Open / activate",
  ...
  queue_error: "Error",
  sdk_changer_subtitle: "Scan and patch SDK/firmware version in installed titles",
  ...
  sdk_sdk: "SDK",
  sdk_warning: "Warning:",
  sdk_warning_text: "SDK patching modifies game binaries and param.json files in-place. Original files are backed up with a .bak suffix. Use at your own risk.",
