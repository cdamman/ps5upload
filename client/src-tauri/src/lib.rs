...
pub fn run() {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::local_image_attach,
            commands::local_image_detach,
            commands::local_image_status,
            commands::cheats_list,
            commands::cheats_get,
            commands::cheats_toggle,
            commands::cheats_delete,
            commands::cheats_reload,
            commands::cheats_status,
            commands::cheats_engine_set,
            commands::cheats_repos_list,
            commands::cheats_repos_search,
            commands::cheats_repos_download,
            commands::activity_get,
            commands::activity_db_query,
            commands::sdk_scan,
            commands::sdk_patch,
            ...
            commands::payloads_add_custom_repo,
            commands::payloads_remove_custom_repo,
